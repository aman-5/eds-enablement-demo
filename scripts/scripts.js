...
/**
 * Applies "Section Metadata" table config to its parent section as classes,
 * then removes the metadata block. The vendored aem.js decorateSections does
 * not process section metadata, so this runs before it.
